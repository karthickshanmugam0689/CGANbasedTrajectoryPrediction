...
with open('ResultTrajectories.pkl', 'rb') as f:
    ...
    for b in a:
        print(b.keys())
        seq_start = int(input("Enter the sequence you wish to visualize:"))
...
anim = animation.FuncAnimation(fig, update, init_func=init, fargs=(scatterplot, positions, colors), interval=500, frames=12, blit=True, repeat=True)
